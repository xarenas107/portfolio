...
div(class='relative min-h-16 overflow-clip bg-default py-24')
  div(v-bind='options' :class='ui.title' class='motion-safe:sticky motion-safe:top-1/3 flex items-start')
    section-title(class='origin-top-left motion-safe:animate-from-[cover,20%] motion-safe:animate-to-[40%,50%] motion-safe:animate-timeline-view motion-safe:animate-fill-both motion-safe:animate-name-[zoom-out,fade-out]' data-cursor="true" hyphens) {{  t('section.skills') }}
...
const ui = {
	title: 'text-default motion-safe:opacity-10 px-4 sm:px-6 m-auto lg:px-8 max-w-7xl'
}
</script>
