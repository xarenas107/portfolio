...
div(class='relative overflow-visible w-full lg:max-w-lg lg:h-full lg:max-h-svh')
	...
	//- tooltip
	span(class='text-xs normal-case truncate font-sans font-normal h-6 px-2 py-1 rounded bg-white dark:bg-gray-900 ring-1 ring-gray-200 dark:ring-gray-800 text-balance fixed z-40 pointer-events-none shadow group max-w-xs move-position motion-safe:animate-float' ref='tooltip') {{ t('itsme') }}
</template>
