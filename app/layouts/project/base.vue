...
div
	u-container(class="min-h-screen py-24 flex flex-col gap-16 relative")
		div(class='flex flex-col gap-12 z-20')
			nuxt-picture(v-if='cover' :src='cover' :alt='title' :img-attrs class="w-full sm:aspect-2/1 md:aspect-3/1 rounded-lg ring bg-elevated h-64 lg:h-80 overflow-clip object-cover")
